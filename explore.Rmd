...
*On average, does conservative or liberal sources have more likes? (after discounting the post with 5446)*
...
#### `favourites_count` 
*Which media sources has engagement from the most favourited tweeter?*
```{r}
...
#### `followers_count` 
*Which media sources has engagement from the tweeters with the highest & lowest follower count??*
